...
function setWeekdayGreeting() {
    ...
    document.getElementById('welcome-title').innerText = `Lumnah Acres Hub — Happy ${currentDay}!`;
}
...
function applyLocalFilters() {
    ...
    if (videoFilter === 'Current' || videoFilter === 'Last') {
        ...
        for(let i = 1; i <= 6; i++) {
            ...
            gridItem.innerHTML = `<img src="${targetMediaFolder}thumbnail.jpg" alt="PBG Archive ${i}">`;
